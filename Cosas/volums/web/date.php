...
// echo date("l") . ", " . date("d") . " de " . date("F") . " del " . date("Y") . " a las ". date("H") . " horas " . date("i") . " minutos i " . date("s") . " segundos". "<br>"; 
// echo "Divendres, 4 d’agost del 2023 a les 19 hores 15 minuts i 00 segons"
